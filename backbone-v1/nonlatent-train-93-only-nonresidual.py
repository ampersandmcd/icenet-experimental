...
class TrainingConfig:
    ...
    output_dir = "results/nonlatent-train-93-only-nonresidual"  # the model name locally and on the HF Hub
...
def validate(config, epoch, unet, condition_ae, scheduler, val_dl, accelerator):
    ...
    with torch.autocast(device_type="cuda"):
        ...
        plt.suptitle("Non-residual Forecast")
